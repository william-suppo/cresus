...
{{--                    {{ __('Accounts') }}--}}
{{--                </a>--}}
                <a href="#" class="{{ Request::is('transactions*') ? 'bg-secondary opacity-100 text-white' : '' }} flex items-center opacity-80 hover:opacity-100 hover:bg-secondary hover:text-white py-4 pl-6">
                    <svg class="h-6 w-6 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
