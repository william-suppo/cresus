    ...
    <body class="antialiased bg-gray-100 h-screen grid md:grid-cols-12" style="font-family: 'Roboto Condensed', sans-serif;">
        <aside class="bg-blue-900 md:col-span-2">
            ...
            <nav class="text-white">
                <a href="#" class="{{ Request::is('dashboard') ? 'bg-gray-100 opacity-100 text-blue-900' : '' }} flex items-center opacity-80 hover:opacity-100 hover:bg-gray-100 hover:text-blue-900 py-4 pl-6">
                ...
                <a href="#" class="{{ Request::is('accounts*') ? 'bg-gray-100 opacity-100 text-blue-900' : '' }} flex items-center opacity-80 hover:opacity-100 hover:bg-gray-100 hover:text-blue-900 py-4 pl-6">
                    <svg class="h-6 w-6 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
