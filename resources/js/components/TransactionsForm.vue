<template>
    <div class="flex flex-wrap mb-2 bg-white rounded shadow p-4">
        ...
        <div class="w-full md:w-2/6 px-3 mb-6 md:mb-0">
            ...
            <input class="appearance-none block w-full bg-gray-100 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="label" name="label" type="text" placeholder="Shopping at ZuperMarket">
        </div>
        <div class="w-full md:w-1/6 px-3 mb-6 md:mb-0">
